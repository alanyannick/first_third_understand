...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', type=str, default='/home/yangmingwen/first_third_person/first_third_result/weight_retina_08_04_Pose_Affordance_Third_Final_Version_Equal_Loss_pretrain/', help='cfg file path')
